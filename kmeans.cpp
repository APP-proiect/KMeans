...
int main()
{
    ...
    //
    auto tmp = std::max_element(init.begin(), init.end(), [](point a, point b)
                                { return a.x < b.x; });
    int max_x = tmp->x;
    tmp = std::max_element(init.begin(), init.end(), [](point a, point b)
                           { return a.y < b.y; });
    int max_y = tmp->y;
    tmp = std::min_element(init.begin(), init.end(), [](point a, point b)
                           { return a.x < b.x; });
    int min_x = tmp->x;
    tmp = std::min_element(init.begin(), init.end(), [](point a, point b)
                           { return a.y < b.y; });
